...
export default function Hero(){
    ...
    return(
        <div style={{
            ...
            }}>Real-time stock insights, AI-powered financial explantion, and paper trading - all in one platform.
            </p>
              <div style={{ display: "flex", gap: "12px", justifyContent: "center" }}>
        <button onMouseEnter={() => setLoginHovered1(true)}
            onMouseLeave={() => setLoginHovered1(false)} style={{
        ...
        <button onMouseEnter={() => setLoginHovered2(true)}
            onMouseLeave={() => setLoginHovered2(false)}style={{
